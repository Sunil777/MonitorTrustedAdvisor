...
<html lang="en">
  ...
  <meta name="request-id" content="8DC3:64BB:128140A:1A84197:5C35D2BD" data-pjax-transient>
...
<meta class="js-ga-set" name="dimension1" content="Logged Out">
    ...
    <meta name="js-proxy-site-detection-payload" content="MWU5OGIzMmZjMGE4OTI4YWUzMjdiZmVkNTU2NDJjMmNlNmZiZDNjYTY0ZjYyYmNhZTY4OGU2NmE3NDBlOTNmMnx7InJlbW90ZV9hZGRyZXNzIjoiMTgyLjc1LjQwLjk4IiwicmVxdWVzdF9pZCI6IjhEQzM6NjRCQjoxMjgxNDBBOjFBODQxOTc6NUMzNUQyQkQiLCJ0aW1lc3RhbXAiOjE1NDcwMzEyMjksImhvc3QiOiJnaXRodWIuY29tIn0=">

    <meta name="enabled-features" content="DASHBOARD_V2_LAYOUT_OPT_IN,EXPLORE_DISCOVER_REPOSITORIES,UNIVERSE_BANNER,MARKETPLACE_PLAN_RESTRICTION_EDITOR">

  <meta name="html-safe-nonce" content="ad0e71aa91ae2b950cef657057fa63065b0fb513">
...
<div class="auth-form px-3" id="login">
    ...
    <!-- '"` --><!-- </textarea></xmp> --></option></form><form action="/session" accept-charset="UTF-8" method="post"><input name="utf8" type="hidden" value="&#x2713;" /><input type="hidden" name="authenticity_token" value="VGdZzd9s3NlSu7I9n6FfZr1akLwDCflxssmvMZXMdK7agNMnFPrCMtkj7+5bnIqd/Xoy8AbsTXA38ooAtPxyXA==" />      <div class="auth-form-header p-0">
      ...
      <p class="create-account-callout mt-3">
        New to GitHub?
        <a data-ga-click="Sign in, switch to sign up" href="/join?return_to=https%3A%2F%2Fgithub.com%2Fp-prakash%2Faws-lambda-functions%2Fedit%2Fmaster%2FMonitorTrustedAdvisor%2FMonitorTrustedAdvisor.py&amp;source=login">Create an account</a>.
      </p>
</div>
